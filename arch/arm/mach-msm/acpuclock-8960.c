...
static struct acpu_level acpu_freq_tbl_8960_kraitv2_slow[] = {
        { 0, { STBY_KHZ, QSB,   0, 0, 0x00 }, L2(0),   775000 },
        { 1, {   384000, PLL_8, 0, 2, 0x00 }, L2(1),   775000 },
        { 0, {   432000, HFPLL, 2, 0, 0x20 }, L2(7),   775000 },
        { 1, {   486000, HFPLL, 2, 0, 0x24 }, L2(7),   800000 },
        { 0, {   540000, HFPLL, 2, 0, 0x28 }, L2(7),   825000 },
        { 1, {   594000, HFPLL, 1, 0, 0x16 }, L2(7),   850000 },
        { 0, {   648000, HFPLL, 1, 0, 0x18 }, L2(7),   875000 },
        { 1, {   702000, HFPLL, 1, 0, 0x1A }, L2(7),   875000 },
        { 0, {   756000, HFPLL, 1, 0, 0x1C }, L2(7),   900000 },
        { 1, {   810000, HFPLL, 1, 0, 0x1E }, L2(7),   900000 },
        { 0, {   864000, HFPLL, 1, 0, 0x20 }, L2(7),   925000 },
        { 1, {   918000, HFPLL, 1, 0, 0x22 }, L2(7),   925000 },
        { 0, {   972000, HFPLL, 1, 0, 0x24 }, L2(7),   975000 },
        { 1, {  1026000, HFPLL, 1, 0, 0x26 }, L2(7),   975000 },
        { 0, {  1080000, HFPLL, 1, 0, 0x28 }, L2(16), 1000000 },
        { 1, {  1134000, HFPLL, 1, 0, 0x2A }, L2(16), 1000000 },
        { 0, {  1188000, HFPLL, 1, 0, 0x2C }, L2(16), 1025000 },
        { 1, {  1242000, HFPLL, 1, 0, 0x2E }, L2(16), 1025000 },
        { 0, {  1296000, HFPLL, 1, 0, 0x30 }, L2(16), 1050000 },
        { 1, {  1350000, HFPLL, 1, 0, 0x32 }, L2(16), 1050000 },
        { 0, {  1404000, HFPLL, 1, 0, 0x34 }, L2(16), 1075000 },
        { 1, {  1458000, HFPLL, 1, 0, 0x36 }, L2(16), 1100000 },
